...
def initialize_tools_and_agents(openai_key, serper_key):
    ...
    return market_research_agent, data_analyst_agent, risk_analyst_agent, advisor_agent, search_tool
...
def run_investment_analysis(investment_data, openai_key, serper_key):
    """Run the complete investment analysis"""
    try:
        # Initialize agents
        agents = initialize_tools_and_agents(openai_key, serper_key)
        search_tool = agents[-1]
        agents = agents[:-1]
...
def main():
    ...
    st.markdown("""
    <div class="info-box">
    <strong>Welcome!</strong> This intelligent investment advisor uses AI agents to analyze global investment 
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        st.markdown("### About")
        st.info("This app uses AI agents to research and analyze investment opportunities across different markets.")
    ...
    if st.button("🚀 Start AI Analysis", type="primary", use_container_width=True):
        if not openai_key or not serper_key:
            st.error("⚠️ Please provide both OpenAI and Serper API keys in the sidebar.")
            ...
            with st.spinner("🤖 AI agents are analyzing investment opportunities... This may take 2-3 minutes."):
                result = run_investment_analysis(investment_data, openai_key, serper_key)
    ...
    <p><strong>Powered by AI Multi-Agent System</strong></p>
    <p>Using CrewAI, OpenAI GPT, and Serper for comprehensive investment analysis</p>
